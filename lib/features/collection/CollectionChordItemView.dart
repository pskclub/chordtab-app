...
class CollectionChordItemView extends StatelessWidget {
  ...
  const CollectionChordItemView({Key? key, required this.item, this.onItemClick, this.onActionClick, this.isRounded = false})
      : super(key: key);
